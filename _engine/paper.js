...
(function(){
  ...
  function mount(item,options){
    addStyle(); const old=document.getElementById("taoThinkingPaper"); if(old)old.remove();
    ...
    host.querySelector(".tao-paper-head").onclick=()=>{host.classList.toggle("open");if(host.classList.contains("open"))requestAnimationFrame(resize);};
